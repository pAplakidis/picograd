CUDA_ERRORS = {
  ...
  # --- EXECUTION / DRIVER / MODULE ERRORS ---
  200: "CUDA_ERROR_NOT_SUPPORTED",                # added
  201: "CUDA_ERROR_INVALID_SOURCE",               # driver API variant
  205: "CUDA_ERROR_NVLINK_REMOTE_ERROR",          # added
  ...
  222: "CUDA_ERROR_INVALID_SOURCE",

  # --- RUNTIME SIDE DUPLICATES ---    
